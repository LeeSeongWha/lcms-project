...
public interface StaffProfessorManageMapper {
	 ...
	 * @return
	 */
	public List<ProfessorVO> selectProfessorList(Map<String, Object> paramMap);
	
	public int selectProfessorTotalCountByKeyword(Map<String, Object> paramMap);
	...
	public int selectProfessorTotalCount();
}
