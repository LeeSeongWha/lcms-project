...
public class StudentGradeServiceImpl implements StudentGradeService {
	...
	@Autowired
	private DGRRequestMapper dgrRequestMapper;
	...
	public Map<String, Object> calculateAcademicStatus(String userNo) {
	    ...
	    int totalCredits = 0;
	    int passedCredits = 0;
	    String departmentNo = studentDepartmentMapper.selectDepartmentNo(userNo);
	    
	    DGRRequestVO dgrRequestVO = dgrRequestMapper.selectDGRRequest(departmentNo);
	    ...
	    int graduationRequiredCredits = dgrRequestVO.getDgrGrade(); // 예시 기준
