...
public class StudentStateServiceImpl implements StudentStateService {
	...
	public List<AcademicChangeRequestVO> readAcademicChangeRequestGraduationSuspension(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return studentStateMapper.selectAcademicChangeRequestGraduationSuspension(paramMap);
	}
	...
	public int readAcademicChangeRequestMajorChangeTotalCount(String userNo) {
		// TODO Auto-generated method stub
		return studentStateMapper.selectAcademicChangeRequestMajorChangeTotalCount(userNo);
	}

	@Override
	public int readAcademicChangeRequestLeaveApplyTotalCount(String userNo) {
		// TODO Auto-generated method stub
		return studentStateMapper.selectAcademicChangeRequestLeaveApplyTotalCount(userNo);
	}

	@Override
	public int readAcademicChangeRequestReturnTotalCount(String userNo) {
		// TODO Auto-generated method stub
		return studentStateMapper.selectAcademicChangeRequestReturnTotalCount(userNo);
	}

	@Override
	public int readAcademicChangeRequestDoubleTotalCount(String userNo) {
		// TODO Auto-generated method stub
		return studentStateMapper.selectAcademicChangeRequestDoubleTotalCount(userNo);
	}

	@Override
	public int readAcademicChangeRequestGraduationSuspensionTotalCount(String userNo) {
		// TODO Auto-generated method stub
		return studentStateMapper.selectAcademicChangeRequestGraduationSuspensionTotalCount(userNo);
	}
}
