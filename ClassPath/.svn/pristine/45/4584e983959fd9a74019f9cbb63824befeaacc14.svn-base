...
public class StudentGradeController {
	...
	public List<LectureEnrVO> gradeListAjax(
	    ...
	    for (LectureEnrVO lectureEnr : lectureEnrList) {
	        ...
	        gradePointSum += lectureEnr.getGradePoint();
	    }
	    
	    System.out.println("GPS == " + gradePointSum);
	    
	    gradePointAvg = gradePointSum / lectureEnrList.size();
	    
	    System.out.println("GPA == " + gradePointAvg);
	...
	public String gradeList(
	    ...
	    if (lectureEnrList == null || lectureEnrList.isEmpty()) {
	    	model.addAttribute("lectureEnrList", List.of()); // 빈 리스트
	        model.addAttribute("gradePointAvg", 0.0);        // 평균도 0
	    	...
	    	double gradePointAvg = gradePointSum / lectureEnrList.size();
	    	...
	    	model.addAttribute("gradePointAvg", gradePointAvg);
	    }
	...
	public String gradeAppealList(
		...
		int totalRecordCount = studentGradeService.readStudentGradeAppealTotalCount(studentNo);
		...
		List<CounselReqVO> gradeAppealList = studentGradeService.readStudentGradeAppealList(paramMap);
