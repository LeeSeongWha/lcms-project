        ...
        if (amount === 0) {
            ...
            axios.post("/student/certificate/paymentComplete", {
            	...
            	try {
                    ...
                    console.error("에러 파싱 실패", parseErr);
...
<div class="section">
	...
	<div class="info-grid">
		...
		<p>
			<strong>· 처리 소요 시간 :</strong> 신청 및 결제 후 즉시
		</p>
		<p>
			<strong>· 발급 방식 :</strong> PDF 다운로드
		</p>
	</div>
	...
	<div class="faq-box">
		...
		<p>
			...
			일반적으로 결제 후 즉시 처리되며, 오류 발생 시 행정실로 문의 주십시오.
		</p>

		<p>
			<strong>Q.</strong> 영문 증명서도 발급되나요?<br> <strong>A.</strong> 영문 증명서는
			발급을 지원하지 않습니다.
		</p>
	</div>
