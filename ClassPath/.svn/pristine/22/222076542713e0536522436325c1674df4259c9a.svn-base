			...
			<c:choose>
				<c:when test="${not empty counselList }">
					<c:forEach items="${counselList }" var="counselList" varStatus="status">
						<c:url 
							value="/student/counsel/departmentCounsel/departmentCounselDetail.do" 
							var="detailURL">
							...
							<div class="modal-dialog modal-dialog-scrollable">
								<div class="modal-content">
									...
									<div class="modal-body">
										<label>담당 교수</label>
										<input type="text" id="couselProf" name="couselProf" class="form-control" value="${counselList.user.userName }" readonly>
										<label>상담 내용</label>
