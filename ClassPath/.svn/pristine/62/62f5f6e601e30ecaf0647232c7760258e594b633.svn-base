...
<form method="post" enctype="multipart/form-data" action="/student/scholarship/scholarshipInsertFormProcess.do" style="padding-bottom:50px;">
	<div class="form-group">
		<label class="inputLabel" for="schTypeNo">장학금 유형</label>
	...
	<div class="form-group">
		<label class="inputLabel" for="requestComment">신청 사유</label>
