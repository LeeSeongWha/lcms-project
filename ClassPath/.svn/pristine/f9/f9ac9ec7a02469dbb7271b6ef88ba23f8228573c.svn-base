...
public class StudentStateController {
	...
	public String studentState(
		...
		List<AcademicChangeRequestVO> majorChangeList = studentStateService.readAcademicChangeRequestMajorChange(paramMap);
		List<AcademicChangeRequestVO> doubleList = studentStateService.readAcademicChangeRequestDouble(paramMap);
		List<AcademicChangeRequestVO> leaveApplyList = studentStateService.readAcademicChangeRequestLeaveApply(paramMap);
		List<AcademicChangeRequestVO> returnList = studentStateService.readAcademicChangeRequestReturn(paramMap);
		List<AcademicChangeRequestVO> graduationSuspensionList = studentStateService.readAcademicChangeRequestGraduationSuspension(paramMap);
	...
	public String majorChangeList(
		...
		int totalRecordCount = studentStateService.readAcademicChangeRequestMajorChangeTotalCount(studentNo);
	...
	public String doubleMajor(
		...
		int totalRecordCount = studentStateService.readAcademicChangeRequestDoubleTotalCount(studentNo);
		paging.setTotalRecordCount(totalRecordCount);
	...
	public String leaveApply(
		...
		int totalRecordCount = studentStateService.readAcademicChangeRequestLeaveApplyTotalCount(studentNo);
		paging.setTotalRecordCount(totalRecordCount);
	...
	public String returnApply(
		...
		int totalRecordCount = studentStateService.readAcademicChangeRequestReturnTotalCount(studentNo);
		paging.setTotalRecordCount(totalRecordCount);
		...
		List<AcademicChangeRequestVO> returnApplyList = studentStateService.readAcademicChangeRequestReturn(paramMap);
	...
	public String graduationSuspensionList(
		...
		int totalRecordCount = studentStateService.readAcademicChangeRequestGraduationSuspensionTotalCount(studentNo);
		paging.setTotalRecordCount(totalRecordCount);
		...
		List<AcademicChangeRequestVO> graduationSuspensionApplyList = studentStateService.readAcademicChangeRequestGraduationSuspension(paramMap);
