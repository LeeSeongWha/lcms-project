...
<div class="container">
	<form method="post" action="/student/completeEvaluation.do" style="display:contents">
		<input type="hidden" name="enrollNo" value="${enrollNo}">
			<div class="form-section">
				<h2>${selectedLecture.lectureReq.lecName} 강의평가</h2>
				<div class="card">
					    ...
					    <div class="form-group" style="flex: 1;">
							<div id="questionList">
								<div class="question-item">
									...
									<input class="inputField" style="width:68%;" type="text" value="${eval.criteriaDesc}" readonly>
				...
				<button type="submit" class="submitButton" style="float:right">등록</button>
			</div>
	</form>
</div>