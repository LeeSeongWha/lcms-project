		...
		<form method="post" action="/student/counsel/graduationSuspensionApplyUpdate.do">
			...
			<div class="form-row" style="display: flex; gap: 20px;">
				<div class="form-group" style="flex: 1;">
					...
					<button class="deleteButton" type="button" onclick="if(confirm('정말 삭제하시겠습니까?')) location.href='/student/counsel/graduationSuspensionApplyDelete.do?no=${graduationSuspensionApply.requestNo}'">삭제</button>
				</div>
				<div class="form-group" style="flex: 1;">
				</div>
			</div>
