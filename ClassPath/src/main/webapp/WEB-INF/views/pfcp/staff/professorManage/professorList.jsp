...
<link rel="stylesheet" href="/dist/assets/css/test/professorList2.css"> 
...
<div class="professorList">
	<div>
		...
		<!-- ======================================== -->
		<form method="get" action="/staff/professorManagement/professorList.do" style="margin-bottom: 1rem;">
			<select name="searchType">
				...
				<option value="proPosition" ${searchType == 'proPosition' ? 'selected' : ''}>직책</option>
				<option value="proStatus" ${searchType == 'proStatus' ? 'selected' : ''}>상태</option>
			</select>
