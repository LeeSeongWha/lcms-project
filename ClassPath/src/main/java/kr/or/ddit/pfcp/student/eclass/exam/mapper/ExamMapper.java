...
public interface ExamMapper {
	...
	public String selectExamNoByExamName(Map<String, Object> paramMap);
	...
	public void upsertExamSubmission(@Param("esNo") String esNo, @Param("userNo") String userNo, @Param("examNo") String examNo);
	
	public String selectSubmissionStatus(@Param("userNo") String userNo, @Param("examNo") String examNo);
	
	public ExamSubmissionVO selectExamSubmission(Map<String, Object> paramMap);
	
	public int insertExamSubmissionStart(Map<String, Object> paramMap);
	
	public int updateExamSubmissionStartTime(Map<String, Object> paramMap);
}
