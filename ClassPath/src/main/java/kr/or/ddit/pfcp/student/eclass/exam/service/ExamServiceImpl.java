...
public class ExamServiceImpl implements ExamService {
	...
	@Override
	public String readExamNoByExamName(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return examMapper.selectExamNoByExamName(paramMap);
	}
	...
	@Override
	public void upsertExamSubmission(String userNo, String examNo) {
		// TODO Auto-generated method stub
		String esNo = "ES" + UUID.randomUUID().toString().replace("-", "").substring(0, 12);
		
	    examMapper.upsertExamSubmission(esNo, userNo, examNo);
	}

	@Override
	public String readSubmissionStatus(String userNo, String examNo) {
		// TODO Auto-generated method stub
		return examMapper.selectSubmissionStatus(userNo, examNo);
	}

	@Override
	public ExamSubmissionVO readExamSubmission(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return examMapper.selectExamSubmission(paramMap);
	}

	@Override
	public int createExamSubmissionStart(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return examMapper.insertExamSubmissionStart(paramMap);
	}

	@Override
	public int modifyExamSubmissionStartTime(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return examMapper.updateExamSubmissionStartTime(paramMap);
	}
	
	@Override
	public LocalDateTime startExam(String userNo, String examNo) {
	    ExamSubmissionVO sub = examMapper.selectExamSubmission(Map.of("userNo", userNo, "examNo", examNo));
	    
	    if (sub == null) {
	        String esNo = "ES" + UUID.randomUUID().toString().replace("-", "").substring(0, 12);
	        examMapper.insertExamSubmissionStart(Map.of(
	            "esNo", esNo,
	            "userNo", userNo,
	            "examNo", examNo
	        ));
	    ...
	    if (sub.getStartTime() == null) {
	        examMapper.updateExamSubmissionStartTime(Map.of("userNo", userNo, "examNo", examNo));
