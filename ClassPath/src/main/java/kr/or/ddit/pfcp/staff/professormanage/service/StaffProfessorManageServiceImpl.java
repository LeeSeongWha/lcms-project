...
public class StaffProfessorManageServiceImpl implements StaffProfessorManageService {
	...
	@Override
	public List<ProfessorVO> readProfessorList(Map<String, Object> paramMap) {
		
		return mapper.selectProfessorList(paramMap);
	}
	...
	@Override
	public int readProfessorTotalCount() {
		// TODO Auto-generated method stub
		return mapper.selectProfessorTotalCount();
	}

	@Override
	public int readProfessorTotalCountByKeyword(Map<String, Object> paramMap) {
		// TODO Auto-generated method stub
		return mapper.selectProfessorTotalCountByKeyword(paramMap);
	}
